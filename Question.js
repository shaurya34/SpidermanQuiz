class Question {
  ...
  display() {
    ...
    this.question.html(
      "Question:- What is the real name of Spiderman 2099  "
    );
    this.question.position(150, 80);
    this.option1.html("1: Tyler Stone ");
    this.option1.position(150, 100);
    this.option2.html("2: Miguel O'Hara");
    this.option2.position(150, 120);
    this.option3.html("3: Peter Panther ");
    this.option3.position(150, 140);
    this.option4.html("4: M'Baku");
